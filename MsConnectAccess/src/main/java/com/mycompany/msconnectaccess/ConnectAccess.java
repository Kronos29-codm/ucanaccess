 ...
 * @author sacro
 */
public class ConnectAccess extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ConnectAccess.class.getName());

    /**
     * Creates new form ConnectAccess
     */
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ConnectAccess().setVisible(true));
    }
